      ...
      for (PlaceContextStructure destination : destinations) {
        ...
        try {
          ...
          for (ApiItinerary itinerary : plan.itineraries) {
            ...
            tripStructure.setStartTime(toLocalDateTime(itinerary.startTime).atZone(zone));
            tripStructure.setEndTime(toLocalDateTime(itinerary.endTime).atZone(zone));
            ...
            for (ApiLeg leg : itinerary.legs) {
              ...
              if (!leg.transitLeg) {
                ...
                dj.getContent().add(factory.createDatedJourneyStructureMode(new ModeStructure().withPtMode(OJPCommon.convertOJPModes(TransitMode.valueOf(leg.mode)))));
          ...
          trip.setTripResponseContext(new TripResponseContextStructure().withPlaces(allPlaces));
